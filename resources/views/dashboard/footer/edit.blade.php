...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-10 mb-4 order-0">
          <div class="header">
            <h3 class="fw-bold">Edit Footer</h3>
           </div>
            <div class="card">
                <div class="d-flex align-items-end row">
                <div class="col-12">
                    <div class="card-body">
                        <form action="/dashboard/footer/{{ $footer->id }}" method="post" enctype="multipart/form-data" class="m-3">
                            @method('put')
                            @csrf
                            <div class="mb-3">
                                <label for="heading" class="form-label">Heading</label>
                                <input type="text" class="form-control @error('heading') is-invalid @enderror" id="heading" 
                                name="heading" required autofocus value="{{ old('heading', $footer->heading) }}">
                                @error('heading')
                              ...
                              <div class="mb-3">
                                ...
                                <textarea class="form-control @error('subHeading') is-invalid @enderror" name="subHeading" id="subHeading" cols="30" rows="5" required autofocus>{{ old('subHeading', $footer->subHeading) }}</textarea>
                                @error('subHeading')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
                              ...
                              <div class="mb-3">
                                ...
                                @if ($footer->image)
                                    <img src="{{ asset('storage/' . $footer->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                                @else
                            ...
                            <div class="mb-3">
                              ...
                              name="copyright" required autofocus value="{{ old('copyright', $footer->copyright) }}">
                              @error('copyright')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
